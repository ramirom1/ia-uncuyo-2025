...
if __name__ == '__main__':
    ...
    if not args.evaluate:
        ...
        # - Every X episodes (parameter), report in log and stdout
        # - At the end, report in log and stdout
        ...
        # Log the final results after all episodes
        text = f'''Final evaluation after {args.episodes} episodes.
            Wins={wins},
            Detections={detected},
            winrate={eval_win_rate:.3f}%,
            detection_rate={eval_detection_rate:.3f}%,
